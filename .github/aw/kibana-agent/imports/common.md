...
- The agent identity is the **kibana-agent** GitHub App. Comments, PR creation, and branch pushes from safe-output jobs appear as **`kibana-agent[bot]`**. Use this handle for assignment and mention semantics.
