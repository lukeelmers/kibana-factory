...
1. Read the issue comments and locate the **latest comment authored by `kibana-agent`** whose heading is **`## Spec (approved)`**. This is the **approved spec** and your **source of truth**. The comment follows a structured template: **Summary**, optionally **Hypotheses** or **Open Questions**, **Acceptance Criteria**, **Execution Plan**, and a collapsible **Details** section (**Affected Areas**, **Test Strategy**).
